...
const Menu = () => {
  ...
  return (
    <div className='bg-black w-[200px] z-10 flex flex-col items-start absolute md:right-32 top-12 right-6 rounded-md p-4 space-y-4'>
       ...
       {user && <h3 className='text-white text-sm hover:text-gray-500'><Link to={"/myblogs/"+user._id}>My blogs</Link></h3>}
